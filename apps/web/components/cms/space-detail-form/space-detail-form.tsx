...
function FeaturesSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({ control, name: "sections.features.items" })
  return (
    <SectionAccordion title="Features" order={3} control={control} visibleName="sections.features.isVisible">
      <LocalizedField control={control} name="sections.features.eyebrow" label="Eyebrow" />
      <LocalizedField control={control} name="sections.features.heading" label="Heading" />
      <LocalizedField control={control} name="sections.features.description" label="Description" multiline />
      <ImageField control={control} name="sections.features.image" label="Section Image" />
      <div className="space-y-3">
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2 rounded-lg border border-zinc-200 p-3">
            <div className="flex-1 space-y-2">
              <PlainField control={control} name={`sections.features.items.${i}.icon`} label="Icon" placeholder="layout" />
              <LocalizedField control={control} name={`sections.features.items.${i}.title`} label="Title" />
              <LocalizedField control={control} name={`sections.features.items.${i}.description`} label="Description" multiline />
              <BoolField control={control} name={`sections.features.items.${i}.isVisible`} label="Visible" />
            </div>
      ...
      <AddItemButton
        label="Add Feature"
        onClick={() => append({ _id: tempId(), icon: "", title: emptyLoc(), description: emptyLoc(), isVisible: true })}
      />
    </SectionAccordion>
  )
}
...
function StylesSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({ control, name: "sections.styles.items" })
  return (
    <SectionAccordion title="Style & Range" order={4} control={control} visibleName="sections.styles.isVisible">
      <LocalizedField control={control} name="sections.styles.eyebrow" label="Eyebrow" />
      <LocalizedField control={control} name="sections.styles.heading" label="Heading" />
      <LocalizedField control={control} name="sections.styles.description" label="Description" multiline />
      <div className="space-y-3">
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2 rounded-lg border border-zinc-200 p-3">
            <div className="flex-1 space-y-2">
              <LocalizedField control={control} name={`sections.styles.items.${i}.title`} label="Title" />
              <LocalizedField control={control} name={`sections.styles.items.${i}.description`} label="Description" multiline />
              <ImageField control={control} name={`sections.styles.items.${i}.image`} label="Image" />
              <div className="grid grid-cols-2 gap-3">
                <PlainField control={control} name={`sections.styles.items.${i}.href`} label="Link URL" />
                <BoolField control={control} name={`sections.styles.items.${i}.isVisible`} label="Visible" />
              </div>
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
          </div>
      ...
      <AddItemButton
        label="Add Style"
        onClick={() => append({ _id: tempId(), title: emptyLoc(), description: emptyLoc(), image: emptyImg(), href: "", isVisible: true })}
      />
      <ButtonField control={control} name="sections.styles.button" label="Section Button" />
      <BoolField control={control} name="sections.styles.autoplay" label="Autoplay carousel" />
    </SectionAccordion>
  )
}
...
function GallerySection({ control }: { control: F }) {
  ...
  return (
    <SectionAccordion title="Gallery / Inspiration" order={5} control={control} visibleName="sections.gallery.isVisible">
      ...
      <AddItemButton
        label="Add Image"
        onClick={() => append({ _id: tempId(), image: emptyImg(), title: emptyLoc(), caption: emptyLoc() })}
      />
...
function MaterialsSection({ control }: { control: F }) {
  ...
  return (
    <SectionAccordion title="Materials & Finishes" order={6} control={control} visibleName="sections.materials.isVisible">
      ...
      <AddItemButton
        label="Add Material"
        onClick={() => append({ _id: tempId(), title: emptyLoc(), description: emptyLoc(), image: emptyImg(), isVisible: true })}
      />
    </SectionAccordion>
  )
}
...
function BrandsSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({ control, name: "sections.brands.brands" })
  return (
    <SectionAccordion title="Trusted Brands" order={7} control={control} visibleName="sections.brands.isVisible">
      <LocalizedField control={control} name="sections.brands.heading" label="Heading" />
      <div className="space-y-3">
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2 rounded-lg border border-zinc-200 p-3">
            <div className="flex-1 space-y-2">
              <PlainField control={control} name={`sections.brands.brands.${i}.name`} label="Brand Name" placeholder="Keller" />
              <ImageField control={control} name={`sections.brands.brands.${i}.logo`} label="Logo" />
              <div className="grid grid-cols-2 gap-3">
                <PlainField control={control} name={`sections.brands.brands.${i}.href`} label="Link URL" />
                <BoolField control={control} name={`sections.brands.brands.${i}.openInNewTab`} label="New tab" />
              </div>
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
          </div>
      ...
      <AddItemButton
        label="Add Brand"
        onClick={() => append({ _id: tempId(), name: "", logo: emptyImg(), href: "", openInNewTab: true })}
      />
    </SectionAccordion>
  )
}
        ...
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2 rounded-lg border border-zinc-200 p-3">
            <div className="flex-1 space-y-2">
              ...
              <LocalizedField control={control} name={`sections.relatedProjects.projects.${i}.description`} label="Description" multiline />
...
function JourneySection({ control }: { control: F }) {
  ...
  return (
    <SectionAccordion title="Project Journey" order={9} control={control} visibleName="sections.journey.isVisible">
...
function FaqSection({ control }: { control: F }) {
  ...
  return (
    <SectionAccordion title="Frequently Asked Questions" order={10} control={control} visibleName="sections.faq.isVisible">
...
function RelatedSpacesSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({ control, name: "sections.relatedSpaces.spaces" })
  return (
    <SectionAccordion title="Related Spaces" order={11} control={control} visibleName="sections.relatedSpaces.isVisible">
      <LocalizedField control={control} name="sections.relatedSpaces.heading" label="Heading" />
      <div className="space-y-3">
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2 rounded-lg border border-zinc-200 p-3">
            <div className="flex-1 space-y-2">
              <PlainField control={control} name={`sections.relatedSpaces.spaces.${i}.spaceType`} label="Space Type" placeholder="wardrobe" />
              <LocalizedField control={control} name={`sections.relatedSpaces.spaces.${i}.title`} label="Title" />
              <ImageField control={control} name={`sections.relatedSpaces.spaces.${i}.image`} label="Image" />
              <div className="grid grid-cols-2 gap-3">
                <PlainField control={control} name={`sections.relatedSpaces.spaces.${i}.href`} label="Link URL" />
                <BoolField control={control} name={`sections.relatedSpaces.spaces.${i}.isVisible`} label="Visible" />
              </div>
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
          </div>
      ...
      <AddItemButton
        ...
        onClick={() => append({ _id: tempId(), spaceType: "", title: emptyLoc(), image: emptyImg(), href: "", isVisible: true })}
      />
      <ButtonField control={control} name="sections.relatedSpaces.button" label="Section Button" />
    </SectionAccordion>
  )
}
...
function ConsultationSection({ control }: { control: F }) {
  return (
    <SectionAccordion title="Consultation CTA" order={12} control={control} visibleName="sections.consultation.isVisible">
      ...
      <ButtonField control={control} name="sections.consultation.button" label="Button" />
    </SectionAccordion>
  )
}
