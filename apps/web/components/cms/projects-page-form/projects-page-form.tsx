...
function ProjectsListSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.projects.projects",
  })
  return (
    <SectionAccordion
      title="All Projects"
    ...
    >
      <LocalizedField
        control={control}
        name="sections.projects.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.projects.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.projects.description"
        label="Description"
        multiline
      />
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              ...
              <LocalizedField
                control={control}
                name={`sections.projects.projects.${i}.shortDescription`}
                label="Short Description"
                multiline
              />
              <ImageField
                control={control}
                name={`sections.projects.projects.${i}.image`}
                label="Image"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`sections.projects.projects.${i}.href`}
                  label="Link URL"
                  placeholder="/projects/emirates-hills"
                />
                <div className="space-y-1.5">
              ...
              <div className="grid grid-cols-2 gap-3">
                <BoolField
                  control={control}
                  name={`sections.projects.projects.${i}.featured`}
                  label="Featured"
                />
                <BoolField
                  control={control}
                  name={`sections.projects.projects.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
      ...
      <ButtonField
        control={control}
        name="sections.projects.loadMoreButton"
        label="Load More Button"
      />
      <div className="grid grid-cols-2 gap-4">
        <BoolField
          control={control}
          name="sections.projects.enableFilters"
          label="Enable Filters"
        />
        <BoolField
          control={control}
          name="sections.projects.enableLoadMore"
...
function TestimonialsSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.testimonials.testimonials",
  })
  return (
    <SectionAccordion
      ...
      order={3}
      control={control}
      visibleName="sections.testimonials.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.testimonials.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.testimonials.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.testimonials.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`sections.testimonials.testimonials.${i}.clientName`}
                label="Client Name"
              />
              <LocalizedField
                control={control}
                name={`sections.testimonials.testimonials.${i}.designation`}
                label="Designation"
              />
              <LocalizedField
                control={control}
                name={`sections.testimonials.testimonials.${i}.testimonial`}
                label="Testimonial"
                multiline
              />
              <ImageField
                control={control}
                name={`sections.testimonials.testimonials.${i}.image`}
                label="Client Photo"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`sections.testimonials.testimonials.${i}.videoUrl`}
                  label="Video URL"
                />
                <BoolField
                  control={control}
                  name={`sections.testimonials.testimonials.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
          ...
          >
            <div className="flex-1 space-y-2">
              ...
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`sections.beforeAfter.items.${i}.projectHref`}
