...
function HeroSection({ control }: { control: Control<HomePageSections> }) {
  return (
    ...
    >
      ...
      <ButtonField
        control={control}
        name="hero.primaryButton"
        label="Primary Button"
      />
      <ButtonField
        control={control}
        name="hero.secondaryButton"
        label="Secondary Button"
      />
      <PlainField
        control={control}
        name="hero.overlayOpacity"
          ...
          >
            <div className="flex-1 space-y-2">
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`stats.statistics.${i}.value`}
                  label="Value"
                  placeholder="500+"
                />
                <BoolField
                  control={control}
                  name={`stats.statistics.${i}.isVisible`}
                  label="Visible"
                />
              </div>
              <LocalizedField
                control={control}
                name={`stats.statistics.${i}.label`}
                label="Label"
              />
            </div>
...
function ServicesSection({ control }: { control: Control<HomePageSections> }) {
  ...
  return (
    <SectionAccordion
      ...
      order={3}
      control={control}
      visibleName="services.isVisible"
    >
      <LocalizedField
        control={control}
          ...
          >
            <div className="flex-1 space-y-2">
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`services.services.${i}.icon`}
                  label="Icon"
                  placeholder="Pencil"
                />
                <PlainField
                  control={control}
                  name={`services.services.${i}.href`}
                  label="Link URL"
                />
              </div>
              <LocalizedField
                control={control}
                name={`services.services.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`services.services.${i}.description`}
                label="Description"
                multiline
              />
              <BoolField
                control={control}
                name={`services.services.${i}.isVisible`}
                label="Visible"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
...
function FeaturedSpacesSection({
  ...
  return (
    <SectionAccordion
      ...
      order={4}
      control={control}
      visibleName="featuredSpaces.isVisible"
    >
      <LocalizedField
        control={control}
        name="featuredSpaces.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="featuredSpaces.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="featuredSpaces.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`featuredSpaces.spaces.${i}.title`}
                label="Title"
              />
              <ImageField
                control={control}
                name={`featuredSpaces.spaces.${i}.image`}
                label="Image"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`featuredSpaces.spaces.${i}.href`}
                  label="Link URL"
                />
                <BoolField
                  control={control}
                  name={`featuredSpaces.spaces.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
...
function SignatureProjectsSection({
  ...
  const { fields, append, remove } = useFieldArray({
    control,
    name: "signatureProjects.projects",
  })
  return (
    <SectionAccordion
      ...
      order={5}
      control={control}
      visibleName="signatureProjects.isVisible"
    >
      <LocalizedField
        control={control}
        name="signatureProjects.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="signatureProjects.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="signatureProjects.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`signatureProjects.projects.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`signatureProjects.projects.${i}.description`}
                label="Description"
                multiline
              />
              <LocalizedField
                control={control}
                name={`signatureProjects.projects.${i}.location`}
                label="Location"
              />
              <ImageField
                control={control}
                name={`signatureProjects.projects.${i}.image`}
                label="Image"
              />
              <div className="grid grid-cols-3 gap-3">
                <PlainField
                  control={control}
                  name={`signatureProjects.projects.${i}.href`}
                  label="Link URL"
                />
                ...
                <BoolField
                  control={control}
                  name={`signatureProjects.projects.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
...
function JourneySection({ control }: { control: Control<HomePageSections> }) {
  ...
  return (
    <SectionAccordion
      ...
      order={6}
      control={control}
      visibleName="journey.isVisible"
    >
      <LocalizedField
        control={control}
        name="journey.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
      ...
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            ...
            <LocalizedField
              control={control}
              name={`journey.steps.${i}.subtitle`}
              label="Subtitle"
            />
            <LocalizedField
              control={control}
              name={`journey.steps.${i}.description`}
              label="Description"
              multiline
            />
            <LocalizedField
              control={control}
              name={`journey.steps.${i}.advantageTitle`}
              label="Advantage Title"
            />
            <LocalizedField
              control={control}
              name={`journey.steps.${i}.advantageDescription`}
              label="Advantage Description"
              multiline
            />
            <LocalizedField
              control={control}
              name={`journey.steps.${i}.highlight`}
              label="Highlight"
              multiline
            />
            <BoolField
              control={control}
              name={`journey.steps.${i}.isVisible`}
              label="Visible"
            />
          </div>
        ))}
...
function WhyChooseSection({ control }: { control: Control<HomePageSections> }) {
  ...
  return (
    <SectionAccordion
      ...
      order={7}
      control={control}
      visibleName="whyChooseT1.isVisible"
    >
      <LocalizedField
        control={control}
        name="whyChooseT1.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="whyChooseT1.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="whyChooseT1.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
    ...
    <div className="space-y-2 rounded-lg border border-zinc-200 p-3">
      <div className="flex items-start gap-2">
        <div className="flex-1 space-y-2">
          <LocalizedField
            control={control}
            name={`whyChooseT1.columns.${colIndex}.title`}
            label="Column Title"
          />
          <BoolField
            control={control}
            name={`whyChooseT1.columns.${colIndex}.highlighted`}
        ...
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2">
            <div className="flex-1 space-y-1">
              <LocalizedField
                control={control}
                name={`whyChooseT1.columns.${colIndex}.items.${i}.label`}
                label={`Item ${i + 1}`}
              />
              <BoolField
                control={control}
                name={`whyChooseT1.columns.${colIndex}.items.${i}.available`}
                label="Available"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
...
function TestimonialsSection({
  ...
  return (
    <SectionAccordion
      ...
      order={8}
      control={control}
      visibleName="testimonials.isVisible"
    >
      <LocalizedField
        control={control}
...
function ConsultationCtaSection({
  ...
  return (
    <SectionAccordion
      ...
      order={9}
      control={control}
      visibleName="consultationCTA.isVisible"
    >
      <LocalizedField
        control={control}
        name="consultationCTA.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="consultationCTA.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="consultationCTA.description"
        label="Description"
        multiline
      />
      <ImageField
        control={control}
        name="consultationCTA.image"
        label="Image"
      />
        ...
        {tabs.fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`consultationCTA.tabs.${i}.label`}
                label="Label"
              />
              <LocalizedField
                control={control}
                name={`consultationCTA.tabs.${i}.description`}
                label="Description"
              />
              <PlainField
                control={control}
                name={`consultationCTA.tabs.${i}.value`}
                label="Value (slug)"
                placeholder="home-owners"
              />
            </div>
        ...
        {fieldsArr.fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`consultationCTA.fields.${i}.label`}
                label="Label"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`consultationCTA.fields.${i}.type`}
                  label="Field Type"
                  placeholder="Text"
                />
              </div>
              <LocalizedField
                control={control}
                name={`consultationCTA.fields.${i}.placeholder`}
                label="Placeholder"
              />
            </div>
      ...
      <LocalizedField
        control={control}
        name="consultationCTA.submitButtonLabel"
...
function PartnershipSection({
  ...
  return (
    <SectionAccordion
      ...
      order={10}
      control={control}
      visibleName="partnership.isVisible"
    >
      <LocalizedField
        control={control}
        name="partnership.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <PlainField
                control={control}
                name={`partnership.steps.${i}.icon`}
                label="Icon"
                placeholder="Headset"
              />
              <LocalizedField
                control={control}
                name={`partnership.steps.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`partnership.steps.${i}.description`}
                label="Description"
                multiline
              />
            </div>
...
function AwardsSection({ control }: { control: Control<HomePageSections> }) {
  ...
  return (
    <SectionAccordion
      ...
      order={11}
      control={control}
      visibleName="awardsRecognition.isVisible"
    >
      <LocalizedField
        control={control}
        name="awardsRecognition.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="awardsRecognition.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="awardsRecognition.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`awardsRecognition.awards.${i}.name`}
                label="Award Name"
              />
              <LocalizedField
                control={control}
                name={`awardsRecognition.awards.${i}.caption`}
                label="Caption"
              />
              <ImageField
                control={control}
                name={`awardsRecognition.awards.${i}.logo`}
                label="Logo"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`awardsRecognition.awards.${i}.href`}
                  label="Link URL"
                />
                <BoolField
                  control={control}
                  name={`awardsRecognition.awards.${i}.openInNewTab`}
                  label="New tab"
                />
              </div>
            </div>
...
function DesignTipsSection({
  ...
  return (
    <SectionAccordion
      ...
      order={12}
      control={control}
      visibleName="designTips.isVisible"
    >
      <LocalizedField
        control={control}
        name="designTips.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="designTips.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="designTips.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`designTips.articles.${i}.title`}
                label="Title"
              />
              <ImageField
                control={control}
                name={`designTips.articles.${i}.image`}
                label="Image"
              />
              <div className="grid grid-cols-2 gap-3">
                <LocalizedField
                  control={control}
                  name={`designTips.articles.${i}.category`}
                  label="Category"
                />
                <LocalizedField
                  control={control}
                  name={`designTips.articles.${i}.readTime`}
                  label="Read Time"
                />
              </div>
              <PlainField
                control={control}
                name={`designTips.articles.${i}.href`}
                label="Link URL"
              />
              <BoolField
                control={control}
                name={`designTips.articles.${i}.isVisible`}
                label="Visible"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`faq.faqs.${i}.question`}
                label="Question"
                multiline
              />
              <LocalizedField
                control={control}
                name={`faq.faqs.${i}.answer`}
                label="Answer"
                multiline
              />
              <BoolField
                control={control}
                name={`faq.faqs.${i}.isVisible`}
                label="Visible"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
...
function LocationLinksSection({
  ...
  return (
    <SectionAccordion
      ...
      order={14}
      control={control}
      visibleName="locationLinks.isVisible"
    >
      <LocalizedField
        control={control}
        name="locationLinks.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="locationLinks.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="locationLinks.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
    ...
    <div className="space-y-2 rounded-lg border border-zinc-200 p-3">
      <div className="flex items-start gap-2">
        <div className="flex-1 space-y-2">
          <LocalizedField
            control={control}
            name={`locationLinks.columns.${colIndex}.title`}
            label="Column Title"
          />
        </div>
        <DeleteItemButton onClick={onRemove} />
        ...
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2">
            <div className="flex-1 space-y-1">
              <LocalizedField
                control={control}
                name={`locationLinks.columns.${colIndex}.links.${i}.label`}
                label={`Link ${i + 1}`}
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`locationLinks.columns.${colIndex}.links.${i}.href`}
                  label="URL"
                />
                <BoolField
                  control={control}
                  name={`locationLinks.columns.${colIndex}.links.${i}.openInNewTab`}
                  label="New tab"
                />
              </div>
            </div>
