...
interface ProjectDetailFormProps {
  ...
  onSave: (
    ...
    | Promise<void | ProjectDetailPageApiData>
}
    ...
    <form onSubmit={submit} className="space-y-4 pb-24">
      ...
      <div className="grid grid-cols-4 gap-3 rounded-lg border border-zinc-200 bg-white p-4">
        <PlainField
          ...
          name="pageName"
          label="Page Name"
          placeholder="Emirates Hills Project"
          required
        />
        <LocalizedField
          control={control}
          ...
          >
            <div className="flex-1 space-y-2">
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`sections.hero.stats.${i}.value`}
                  label="Value"
                  placeholder="430+"
                />
                <PlainField
                  control={control}
                  name={`sections.hero.stats.${i}.icon`}
                  label="Icon"
                  placeholder="area"
                />
              </div>
              <LocalizedField
                control={control}
                name={`sections.hero.stats.${i}.label`}
                label="Label"
              />
            </div>
...
function OverviewSection({ control }: { control: F }) {
  return (
    <SectionAccordion
      ...
      order={2}
      control={control}
      visibleName="sections.overview.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.overview.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.overview.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.overview.description"
        label="Description"
        multiline
      />
      <ImageField
        control={control}
        name="sections.overview.image"
        label="Image"
      />
      <div className="space-y-1.5">
...
function BeforeAfterSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.beforeAfter.items",
  })
  return (
    <SectionAccordion
      title="Before & After"
      order={3}
      control={control}
      visibleName="sections.beforeAfter.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.beforeAfter.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.beforeAfter.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.beforeAfter.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`sections.beforeAfter.items.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`sections.beforeAfter.items.${i}.description`}
                label="Description"
                multiline
              />
              <ImageField
                control={control}
                name={`sections.beforeAfter.items.${i}.beforeImage`}
                label="Before Image"
              />
              <ImageField
                control={control}
                name={`sections.beforeAfter.items.${i}.afterImage`}
                label="After Image"
              />
              <BoolField
                control={control}
                name={`sections.beforeAfter.items.${i}.isVisible`}
                label="Visible"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
      ...
      <div className="grid grid-cols-2 gap-4">
        <BoolField
          control={control}
          name="sections.beforeAfter.autoplay"
          label="Autoplay"
        />
        <BoolField
          control={control}
          name="sections.beforeAfter.showNavigation"
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              ...
              <BoolField
                control={control}
                name={`sections.gallery.images.${i}.isVisible`}
                label="Visible"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              ...
              <LocalizedField
                control={control}
                name={`sections.materials.materials.${i}.subtitle`}
                label="Subtitle"
              />
              <LocalizedField
                control={control}
...
function ProjectInfoSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.projectInfo.details",
  })
  return (
    <SectionAccordion
      ...
      order={6}
      control={control}
      visibleName="sections.projectInfo.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.projectInfo.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.projectInfo.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.projectInfo.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <PlainField
                control={control}
                name={`sections.projectInfo.details.${i}.icon`}
                label="Icon"
                placeholder="home"
              />
              <LocalizedField
                control={control}
                name={`sections.projectInfo.details.${i}.label`}
                label="Label"
              />
              <LocalizedField
                control={control}
                name={`sections.projectInfo.details.${i}.value`}
                label="Value"
              />
              <BoolField
                control={control}
                name={`sections.projectInfo.details.${i}.isVisible`}
                label="Visible"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
      ...
      <ButtonField
        control={control}
        name="sections.projectInfo.button"
...
function TestimonialSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.testimonial.testimonials",
  })
  return (
    <SectionAccordion
      ...
      order={7}
      control={control}
      visibleName="sections.testimonial.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.testimonial.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.testimonial.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.testimonial.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`sections.testimonial.testimonials.${i}.clientName`}
                label="Client Name"
              />
              <LocalizedField
                control={control}
                name={`sections.testimonial.testimonials.${i}.designation`}
                label="Designation"
              />
              <LocalizedField
                control={control}
                name={`sections.testimonial.testimonials.${i}.quote`}
                label="Quote"
                multiline
              />
              <ImageField
                control={control}
                name={`sections.testimonial.testimonials.${i}.image`}
                label="Client Photo"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`sections.testimonial.testimonials.${i}.videoUrl`}
                  label="Video URL"
                />
                <BoolField
                  control={control}
                  name={`sections.testimonial.testimonials.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
      ...
      <BoolField
        control={control}
        name="sections.testimonial.autoplay"
        label="Autoplay"
      />
    </SectionAccordion>
  )
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <PlainField
                control={control}
                name={`sections.relatedProjects.projects.${i}.projectSlug`}
                label="Project Slug"
              ...
              <LocalizedField
                control={control}
                name={`sections.relatedProjects.projects.${i}.category`}
                label="Category"
              />
              <ImageField
                control={control}
...
function ConsultationSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.consultation.fields",
  })
  return (
    <SectionAccordion
...
function ConsultationFieldCard({
  control,
  index,
  onRemove,
}: {
    ...
    <div className="flex items-start gap-2 rounded-lg border border-zinc-200 p-3">
      <div className="flex-1 space-y-2">
        <div className="grid grid-cols-2 gap-3">
          <PlainField
            control={control}
            name={`sections.consultation.fields.${index}.name`}
        ...
        <LocalizedField
          control={control}
          name={`sections.consultation.fields.${index}.label`}
          label="Label"
        />
        <LocalizedField
          control={control}
          name={`sections.consultation.fields.${index}.placeholder`}
          label="Placeholder"
        />
        <BoolField
          control={control}
          name={`sections.consultation.fields.${index}.required`}
          label="Required"
        />
        ...
        <div className="space-y-2 border-t border-zinc-100 pt-2">
            ...
            {fields.map((of, oi) => (
              <div key={of.id} className="flex items-center gap-2">
                <div className="w-32">
                  <PlainField
                    control={control}
                    name={`sections.consultation.fields.${index}.options.${oi}.value`}
                    label="Value"
                    placeholder="villa"
                  />
                </div>
                <div className="flex-1">
                  <LocalizedField
                    control={control}
                    name={`sections.consultation.fields.${index}.options.${oi}.label`}
                    label="Label"
                  />
                </div>
                <div className="pt-6">
          ...
          <AddItemButton
            label="Add Option"
            onClick={() => append({ value: "", label: emptyLoc() })}
          />
        </div>
      </div>
