...
interface SpacesPageFormProps {
  ...
  ) => void | SpacesPageApiData | Promise<void | SpacesPageApiData>
}
...
function FeaturedSpacesSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.featuredSpaces.spaces",
  })
  return (
    <SectionAccordion
      ...
      order={3}
      control={control}
      visibleName="sections.featuredSpaces.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.featuredSpaces.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.featuredSpaces.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.featuredSpaces.description"
        label="Description"
        multiline
      />
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`sections.featuredSpaces.spaces.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`sections.featuredSpaces.spaces.${i}.subtitle`}
                label="Subtitle"
              />
              <ImageField
                control={control}
                name={`sections.featuredSpaces.spaces.${i}.image`}
                label="Image"
              />
              <div className="grid grid-cols-2 gap-3">
                <PlainField
                  control={control}
                  name={`sections.featuredSpaces.spaces.${i}.href`}
                  label="Link URL"
                  placeholder="/spaces/kitchens"
                />
                <BoolField
                  control={control}
                  name={`sections.featuredSpaces.spaces.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
      ...
      <ButtonField
        control={control}
        name="sections.featuredSpaces.button"
        label="Section Button"
      />
      <BoolField
        control={control}
        name="sections.featuredSpaces.autoplay"
...
function ShowcaseSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.showcase.gallery",
  })
  return (
    <SectionAccordion
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <ImageField
                control={control}
                name={`sections.showcase.gallery.${i}.image`}
                label="Image"
              />
              <LocalizedField
                control={control}
                name={`sections.showcase.gallery.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`sections.showcase.gallery.${i}.caption`}
                label="Caption"
              />
              <PlainField
                control={control}
                name={`sections.showcase.gallery.${i}.href`}
                label="Link URL"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
...
function WhyChooseSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.whyChooseT1.columns",
  })
  return (
    <SectionAccordion
      title="Why Choose T1"
      order={5}
      control={control}
      visibleName="sections.whyChooseT1.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.whyChooseT1.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.whyChooseT1.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.whyChooseT1.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
    ...
    <div className="space-y-2 rounded-lg border border-zinc-200 p-3">
      <div className="flex items-start gap-2">
        <div className="flex-1 space-y-2">
          <LocalizedField
            control={control}
            name={`sections.whyChooseT1.columns.${colIndex}.title`}
            label="Column Title"
          />
          <BoolField
            control={control}
            name={`sections.whyChooseT1.columns.${colIndex}.highlighted`}
      ...
      <div className="space-y-2 border-t border-zinc-100 pt-2">
        {fields.map((f, i) => (
          <div key={f.id} className="flex items-start gap-2">
            <div className="flex-1 space-y-1">
              <LocalizedField
                control={control}
                name={`sections.whyChooseT1.columns.${colIndex}.items.${i}.label`}
                label={`Item ${i + 1}`}
              />
              <BoolField
                control={control}
                name={`sections.whyChooseT1.columns.${colIndex}.items.${i}.available`}
                label="Available"
              />
            </div>
            <DeleteItemButton onClick={() => remove(i)} />
        ...
        <AddItemButton
          label="Add Item"
          onClick={() => append({ label: emptyLoc(), available: true })}
        />
      </div>
    </div>
  )
...
function SignatureProjectsSection({ control }: { control: F }) {
  const { fields, append, remove } = useFieldArray({
    control,
    name: "sections.signatureProjects.projects",
  })
  return (
    <SectionAccordion
      ...
      order={6}
      control={control}
      visibleName="sections.signatureProjects.isVisible"
    >
      <LocalizedField
        control={control}
        name="sections.signatureProjects.eyebrow"
        label="Eyebrow"
      />
      <LocalizedField
        control={control}
        name="sections.signatureProjects.heading"
        label="Heading"
      />
      <LocalizedField
        control={control}
        name="sections.signatureProjects.description"
        label="Description"
        multiline
      />
      <div className="space-y-3">
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <LocalizedField
                control={control}
                name={`sections.signatureProjects.projects.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`sections.signatureProjects.projects.${i}.location`}
                label="Location"
              />
              <LocalizedField
                control={control}
                name={`sections.signatureProjects.projects.${i}.description`}
                label="Description"
                multiline
              />
              <ImageField
                control={control}
                name={`sections.signatureProjects.projects.${i}.image`}
                label="Image"
              />
              <div className="grid grid-cols-3 gap-3">
                <PlainField
                  control={control}
                  name={`sections.signatureProjects.projects.${i}.href`}
                  label="Link URL"
                />
                <div className="space-y-1.5">
                ...
                <BoolField
                  control={control}
                  name={`sections.signatureProjects.projects.${i}.isVisible`}
                  label="Visible"
                />
              </div>
            </div>
      ...
      <ButtonField
        control={control}
        name="sections.signatureProjects.button"
        label="Section Button"
      />
    </SectionAccordion>
  )
        ...
        {fields.map((f, i) => (
          ...
          >
            <div className="flex-1 space-y-2">
              <PlainField
                control={control}
                name={`sections.partnership.steps.${i}.icon`}
                label="Icon"
                placeholder="register"
              />
              <LocalizedField
                control={control}
                name={`sections.partnership.steps.${i}.title`}
                label="Title"
              />
              <LocalizedField
                control={control}
                name={`sections.partnership.steps.${i}.description`}
                label="Description"
                multiline
              />
            </div>
