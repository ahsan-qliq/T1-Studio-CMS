...
export default async function TradePage() {
  let initialData
  try { initialData = await fetchTradePage() } catch { initialData = createEmptyTradePage() }
  return <div className="mx-auto w-full px-6 py-6"><TradePageFormClient initialData={initialData} /></div>
}
